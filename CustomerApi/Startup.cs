...
namespace CustomerApi
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<CustomerDbContext>(context =>
            { context.UseSqlServer(Configuration["ConnectionString"]); });
            services.AddTransient<CustomerDbContext, CustomerDbContext>();
